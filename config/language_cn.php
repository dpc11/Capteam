...
$multilingual_project_tips2 = "只有团队成员才能参与项目完成相应操作，您也可以在稍后添加成员";
...
$multilingual_schedule_course_tip = "<p>课程日程可修改并展示课程表视图</p><br />
<p>课程日程由用户自己添加，精确到小时，点击日历空白处即可进入添加课程模态框，点击事件标签可查看并编辑已有的课程安排。</p><br />
<p>添加课程之前需选择学期开始日期，并且开始日期必须为“星期一”。</p><br />
<p>添加课程时需填写课程的周范围、每周上课日、课程开始结束时间等必要信息。</p>
";
