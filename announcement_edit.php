...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tk_announcement SET tk_anc_title=%s, tk_pid=%s, $tk_anc_text tk_anc_type=%s WHERE aid=%s",
					...
					<td >
						<table width="98%" border="0" cellspacing="0" cellpadding="5" align="center">
							...
							<div class="form-group" style="width: 400px;">
								...
								<div>
									<input type="text" name="tk_anc_title" id="tk_anc_title"  class="form-control" value="<?php echo $row_Recordset1['tk_anc_title']; ?>" placeholder="<?php echo $multilingual_announcement_title; ?>" />
								</div>
							</div>
								</td >
								<td width="420px">
							<div class="form-group "  style="width: 400px;">
								...
								<div>
									...
									<?php do {  ?> 
									  <option value="<?php echo $row_teamleader_lists['tk_team_pid']; ?>" <?php if (!(strcmp($row_teamleader_lists['tk_team_pid'], $row_Recordset1['tk_anc_type']))) {echo "selected=\"selected\"";} ?>><?php echo $row_teamleader_lists['project_name']; ?></option>
							...
							<!-- 提交按钮 -->
								<tr >
									...
									<td  width="20%" align="center" >
										...
										value="<?php echo $colname_Recordset1; ?>" />
