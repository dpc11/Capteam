...
$cc_post= "[".implode(",",$_POST['user_cc'])."]";
  ...
  $updateSQL = sprintf("UPDATE tk_task SET  csa_from_user=%s, csa_to_user=%s, csa_text=%s, csa_priority=%s,  csa_plan_st=%s, csa_plan_et=%s, $plan_hour, $csa_remark1, csa_testto=%s,csa_last_update='$timenow'  WHERE tid=%s",
