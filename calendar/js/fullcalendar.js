                    ...
                    if ("title" == i) a.append("<span class='fc-header-title'><h2>&nbsp;</h2></span>"), o && o.addClass(v + "-corner-right"), o = null;
                        ...
                        if (n[i] ? s = n[i] : Se[i] && (s = function () {
                            ...
                            var l = r.theme ? P(r.buttonIcons, i) : null,
                                c = P(r.buttonText, i),
                                u = t("<span class='fc-button fc-button-" + i + " " + "btn btn-default btn-sm'>" + (l ? "<span class='fc-icon-wrap'><span class='ui-icon ui-icon-" + l + "'/>" + "</span>" : c) + "</span>")
                            .click(function () {
...
//                                })
        ...
        function l(t) {
            h.find("span.fc-button-" + t).addClass("active")
        }

        function c(t) {
            h.find("span.fc-button-" + t).removeClass("active")
        }
