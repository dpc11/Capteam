...
//message
$welcome=urlencode("欢迎来到房间 $room!<BR><font color=\"#3CA2DE\">&#187;</font> 点击顶部的按钮来激活或者停止相关的功能和面板。<BR><font color=\"#3CA2DE\">&#187;</font> 点击用户列表会弹出权限允许的对用户的操作，其中组长具有管理员的权限。 <BR><font color=\"#3CA2DE\">&#187;</font> 在文本框中粘贴视频地址、网页地址、邮箱或者其他链接，将会自动解析为可点击的链接。 <BR><font color=\"#3CA2DE\">&#187;</font>文件列表里可以下载每天的日志。");
